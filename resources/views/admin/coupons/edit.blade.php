                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6" id="maxDiscountContainer">
                                ...
                                <input type="number" step="0.01" name="max_discount" id="max_discount" class="form-control" placeholder="Deduction Limit" value="{{ old('max_discount', $coupon->max_discount) }}" min="0">
                            </div>
                            <div class="col-md-6">
