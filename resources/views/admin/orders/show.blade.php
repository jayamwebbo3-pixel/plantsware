            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <form action="{{ route('admin.orders.updateStatus', $order) }}" method="POST" class="mb-2">
                        ...
                        <button type="submit" class="btn btn-success w-100" onclick="return confirm('Approve the return and mark as Returned?')">Approve Return</button>
                    </form>
                    ...
                    <form action="{{ route('admin.orders.updateStatus', $order) }}" method="POST">
                        ...
                        <div class="input-group">
                            ...
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Reject this return request?')">Reject Return</button>
                        </div>
                    </form>
                </div>
                @else
