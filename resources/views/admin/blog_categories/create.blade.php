                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" required placeholder="Enter category title">
                        </div>
                        ...
                        <div class="card bg-light border-0">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Recommended size: 400x250 pixels</small>
                                </div>
...
<style>
    .btn-success { background-color: #6ea820; border-color: #6ea820; }
    .btn-success:hover { background-color: #5d8e1a; border-color: #5d8e1a; }
</style>
@endsection
