            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="sort_order" id="sort_order" value="{{ $next_sort_order ?? 1 }}">
                        <small class="text-primary fw-bold">Next available: {{ $next_sort_order ?? 1 }} (Last: {{ ($next_sort_order ?? 1) - 1 }})</small>
                    </div>
                </div>
